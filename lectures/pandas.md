...
```{figure} /_static/lecture/pandas/pandas_vs_rest.png
:scale: 100
```
...
```{figure} /_static/lecture/pandas/pandas_share_prices.png
:scale: 80
```
...
```{figure} /_static/lecture/pandas/pandas_indices_pctchange.png
:scale: 80
```
