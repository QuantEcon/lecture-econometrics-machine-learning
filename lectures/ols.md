...
```{code-cell} python3
df1 = pd.read_stata('https://github.com/QuantEcon/lecture-python/blob/master/source/_static/lecture/ols/maketable1.dta?raw=true')
df1.head()
```
...
```{code-cell} python3
df2 = pd.read_stata('https://github.com/QuantEcon/lecture-python/blob/master/source/_static/lecture/ols/maketable2.dta?raw=true')
...
df4 = pd.read_stata('https://github.com/QuantEcon/lecture-python/blob/master/source/_static/lecture/ols/maketable4.dta?raw=true')
